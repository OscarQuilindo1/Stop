 ...
 */
public class JstopIniciar extends javax.swing.JFrame {

    /**
     * Creates new form JstopIniciar
     */
    public JstopIniciar() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JstopIniciar.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new JstopIniciar().setVisible(true);
            }
        });
    }
